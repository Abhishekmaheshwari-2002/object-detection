...
const ObjectDetection = () => {
    ...
    const showMyVideo = () => {
        if (
            ...
            const myVideoW = webcamRef.current.video.videoWidth;
            const myVideoH = webcamRef.current.video.videoHeight;

            webcamRef.current.video.width = myVideoW;
            webcamRef.current.video.height = myVideoH;
        }
    };
    useEffect(() => {
        runCoco();
